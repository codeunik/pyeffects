...
class Place:
    ...
    def to_pos(self, pos_x, pos_y, pos_z=0, anchor=[0.5, 0.5, 0.5]):
        ...
        return np.array([pos_x - anchor[0], pos_y - anchor[1], pos_z - anchor[2]])
    ...
    def to_relative_of(self,
        ...
        target_anchor[0] = target_anchor[0] if fix[0] else anchor[0]
        target_anchor[1] = target_anchor[1] if fix[0] else anchor[1]
        target_anchor[2] = target_anchor[2] if fix[0] else anchor[2]
    ...
    def place_at_relative_of(self,
        ...
        self.translate(*self.to_relative_of(target, target_anchor, anchor, fix, offset))
        return self
